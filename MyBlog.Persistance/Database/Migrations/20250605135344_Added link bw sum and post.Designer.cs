...
namespace MyBlog.Persistance.Database.Migrations
{
    ...
    [Migration("20250605135344_Added link bw sum and post")]
    partial class Addedlinkbwsumandpost
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyBlog.Domain.Entities.Summarizations.Summarization", b =>
                {
                    ...
                    b.HasOne("MyBlog.Domain.Entities.Post", "Post")
                        .WithOne("Summarization")
                        .HasForeignKey("MyBlog.Domain.Entities.Summarizations.Summarization", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
